...
export function StepIndicator({
  ...
  // Simple variant - just text with chevrons
  if (variant === "simple") {
    return (
            ...
            return (
              <li key={step.id} className="flex items-center">
                <span
                  className={cn(
                    "px-2 py-1 rounded",
                    status === "current" && "font-medium text-primary bg-primary/10",
              ...
              <li key={step.id} className="relative">
                ...
                >
                  ...
                  {variant === "numbered" ? (
                    <div
                      className={cn(
                        "flex-shrink-0 rounded-full border-2 flex items-center justify-center font-semibold transition-colors",
                    ...
                    <div
                      className={cn(
                        ...
                        sizeClasses[size].step,
                        status === "complete" && "bg-success-500 text-white",
        ...
        {steps.map((step, index) => {
          ...
          return (
            ...
            >
              ...
              {!isLast && (
                <div
                  className="hidden sm:block absolute top-4 left-1/2 right-0 mx-4"
